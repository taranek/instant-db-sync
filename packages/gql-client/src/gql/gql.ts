...
export type DeleteFromIssuesCollectionMutation = {
  __typename?: "Mutation";
...
export type DeleteFromUsersCollectionMutation = {
  __typename?: "Mutation";
...
export type InsertIntoIssuesCollectionMutation = {
  __typename?: "Mutation";
...
export type InsertIntoUsersCollectionMutation = {
  __typename?: "Mutation";
...
export type UpdateIssuesCollectionMutation = {
  __typename?: "Mutation";
...
export type UpdateUsersCollectionMutation = {
  __typename?: "Mutation";
...
export type IssuesCollectionQuery = {
  __typename?: "Query";
  issuesCollection?: {
    __typename?: "IssuesConnection";
    edges: Array<{
...
export type NodeQuery = {
  __typename?: "Query";
  node?:
    | { __typename?: "Issues"; nodeId: string }
    | { __typename?: "Users"; nodeId: string }
    | null;
};
...
export const UpdateIssuesCollectionDocument = gql`
  mutation updateIssuesCollection(
    $set: IssuesUpdateInput!
    $filter: IssuesFilter
    $atMost: Int!
  ) {
...
export const UpdateUsersCollectionDocument = gql`
  mutation updateUsersCollection(
    $set: UsersUpdateInput!
    $filter: UsersFilter
    $atMost: Int!
  ) {
...
export function getSdk(
  ...
  return {
    deleteFromIssuesCollection(
      variables: DeleteFromIssuesCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<DeleteFromIssuesCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteFromIssuesCollectionMutation>(
            DeleteFromIssuesCollectionDocument,
            variables,
    ...
    deleteFromUsersCollection(
      variables: DeleteFromUsersCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<DeleteFromUsersCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteFromUsersCollectionMutation>(
            DeleteFromUsersCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "deleteFromUsersCollection",
    ...
    insertIntoIssuesCollection(
      variables: InsertIntoIssuesCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<InsertIntoIssuesCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<InsertIntoIssuesCollectionMutation>(
            InsertIntoIssuesCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "insertIntoIssuesCollection",
    ...
    insertIntoUsersCollection(
      variables: InsertIntoUsersCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<InsertIntoUsersCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<InsertIntoUsersCollectionMutation>(
            InsertIntoUsersCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "insertIntoUsersCollection",
    ...
    updateIssuesCollection(
      variables: UpdateIssuesCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UpdateIssuesCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateIssuesCollectionMutation>(
            UpdateIssuesCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "updateIssuesCollection",
    ...
    updateUsersCollection(
      variables: UpdateUsersCollectionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UpdateUsersCollectionMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateUsersCollectionMutation>(
            UpdateUsersCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "updateUsersCollection",
    ...
    issuesCollection(
      variables?: IssuesCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<IssuesCollectionQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<IssuesCollectionQuery>(
            IssuesCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "issuesCollection",
    ...
    node(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NodeQuery>(NodeDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "node",
    ...
    usersCollection(
      variables?: UsersCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UsersCollectionQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UsersCollectionQuery>(
